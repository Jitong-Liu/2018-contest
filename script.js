...
const size = 4;
const width = canvas.width / size - 6;
let cells = [];
let fontSize;
let loss = false;
startGame();
...
function drawCell(cell) {
    ...
    switch (cell.value){
        case 0 : ctx.fillStyle = '#c6b8ab'; break;
        case 2 : ctx.fillStyle = '#e2e0d5'; break;
        case 4 : ctx.fillStyle = '#eadbc1'; break;
        case 8 : ctx.fillStyle = '#FF7F50'; break;
